...
export class BridgeTransactionModel extends Model<BridgeTransactionAttributes, BridgeTransactionAttributes> implements BridgeTransactionAttributes {
	@Column({
		primaryKey: true,
		type: DataType.BIGINT,
		defaultValue: Sequelize.literal("nextval('bridge_transaction_id_seq'::regclass)")
	})
	@Index({
