...
export default class OrbiterAccount extends IAccount {
    ...
    public transfer(to: string, value: string, transactionRequest?: TransactionRequest | undefined): Promise<TransferResponse | undefined> {
    ...
    public transferToken(token: string, to: string, value: string, transactionRequest?: TransactionRequest | undefined): Promise<TransferResponse | undefined> {
        throw new Error('Method not implemented.');
    }
}
